      ...
      <div className="bg-gray-900 dark:bg-gray-800 text-white rounded-lg shadow-lg p-4">
        <div className="flex items-start gap-3">
          <p className="text-sm text-gray-300 flex-1">
            We use cookies.{' '}
            <Link href="/privacy" className="text-coral-400 hover:underline">
              Learn more
            </Link>
          </p>
          <button
        ...
        <div className="flex gap-2 mt-3">
          ...
          <button
            ...
            className="flex-1 px-3 py-1.5 text-xs text-white bg-coral-500 rounded hover:bg-coral-600 transition-colors"
          >
            Accept
          </button>
        </div>
